...
r_lat_true = 51.079953730555555555555555555556;
r_long_true =-114.13384820555555555555555555556;
r_alt_true = 1118.792;
...
stop = 1;
 ...
 [residue elevation availablePRN MDBout dx_ext_relH dx_ext_relV]=arrangeResidue(run,epochs,MDB,dx_ext_rel);
  ...
  fprintf( fid, '%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f\n', ...
      residue(k,1), residue(k,2), residue(k,3), residue(k,4), residue(k,5),...
      residue(k,6), residue(k,7), residue(k,8), residue(k,9), residue(k,10),...
      residue(k,11), residue(k,12), residue(k,13), residue(k,14), residue(k,15),...
      residue(k,16), residue(k,17), residue(k,18), residue(k,19), residue(k,20),...
      residue(k,21), residue(k,22), residue(k,23));
  end
